...
d3.csv("/src/data/b_depressed.csv")
    .then((data) => {
        ...
        const filterData = (data) => {
            ...
            console.log(data.filter((d) => d.Survey_id == filters.Survey_id && d.depressed == filters.depressed))
            return data.filter((d) => d.Survey_id == filters.Survey_id && d.depressed == filters.depressed);
